...
public class InternalMyDslLexer extends Lexer {
	...
	public final void mRULE_DOUBLE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// InternalMyDsl.g:933:13: ( ( '-' | '.' | 'e' | RULE_INT )+ )
			// InternalMyDsl.g:933:15: ( '-' | '.' | 'e' | RULE_INT )+
			{
			// InternalMyDsl.g:933:15: ( '-' | '.' | 'e' | RULE_INT )+
			int cnt1=0;
			loop1:
			while (true) {
				...
				switch (alt1) {
				case 1 :
					// InternalMyDsl.g:933:16: '-'
					{
					match('-'); 
					}
					break;
				case 2 :
					// InternalMyDsl.g:933:20: '.'
					{
					match('.'); 
					}
					break;
				case 3 :
					// InternalMyDsl.g:933:24: 'e'
					{
					match('e'); 
					}
					break;
				case 4 :
					// InternalMyDsl.g:933:28: RULE_INT
					{
					mRULE_INT(); 
